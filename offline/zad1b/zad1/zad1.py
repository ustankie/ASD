...
def ceasar( s ):
    ...
    r[0]=0 #pierwszy i ostatni promien sa rowne 0 - zapisujac je w tablicy od razu oszczedzamy czas procesora, 
    r[n-1]=0 #gdyz wywolanie funkcji pal_count (CALL) jest bardziej czasochlonne niz reczne wpisanie do tablicy
