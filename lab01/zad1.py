...
#2)znajdowanie inwersji w tablicy (zliczanie) - z mergesortem
...
#wejscie: lewy grn rog kazdgo prost, powierzchnia wody
#sortujemy linie i +/-
#+dolna linia -grn linia (nlogn)
####BEZ SORTOWANIA
#bisekcja - min i max klockow - strzelamy poziom wody w polowie - troche gorzej niz nlogn
#4)zbior przedzialow - znalezc przedzial, ktory zawiera jak najwiecej innych
class Node():
